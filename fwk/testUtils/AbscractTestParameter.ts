...
export class AbstractTestParameter {
   ...
   */
  public static initCommonParameters(testParameterFilePath: string): void {
    if (!!testParameterFilePath) {
      this.data = JSON.parse(fs.readFileSync(testParameterFilePath, 'utf-8'));
    }
